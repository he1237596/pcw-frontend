...
const request = {
  get<T = any>(url: string, params?: object, config?: AxiosRequestConfig):Promise<ApiResponse<T>> {
    ...
    return new Promise((resolve, reject) => {
      service.get<ApiResponse<T>>(url, { params, ...config })
  ...
  post<T = any>(url: string, data?: object, config?: AxiosRequestConfig):Promise<ApiResponse<T>> {
    ...
    return new Promise((resolve, reject) => {
      service.post<ApiResponse<T>>(url, data, config)
      .then((res) => resolve(res.data))
      .catch((err) => {
        if (err.code) {
          resolve({
  ...
  put<T = any>(url: string, data?: object, config?: AxiosRequestConfig):Promise<ApiResponse<T>> {
    ...
    return new Promise((resolve, reject) => {
      service.put<ApiResponse<T>>(url, data, config)
      .then((res) => resolve(res.data))
      .catch((err) => {
        if (err.code) {
          resolve({
  ...
  delete<T = any>(url: string, params?: object, config?: AxiosRequestConfig):Promise<ApiResponse<T>> {
    ...
    return new Promise((resolve, reject) => {
      service.delete<ApiResponse<T>>(url, { params, ...config })
      .then((res) => resolve(res.data))
      .catch((err) => {
        if (err.code) {
          resolve({
  ...
  // get带token的下载文件
  // todo: 未测试
  downloadFile<T>(url: string, params?: object, config?: AxiosRequestConfig): Promise<void> {
    return new Promise((resolve, reject) => {
      service.get(url, { 
        responseType: 'blob',     
        params, 
